...
public:
					...
					match_distance_threshold_(30.0)
	{
		...
		this->declare_parameter<std::string>("serial_port", "/dev/pts/4");
		...
		RCLCPP_INFO(this->get_logger(), "shooter process was successfully launched. serial_port:%s", serial_port_.c_str());
